...
echo json_encode(array(
    $tryed_module['db_alias'] =
        'html_validation' => ($age_restriction->get_plugin_status() != 'valid_hash' ? array(
        	'validation' => array(
            'title' => 'Unlock - Age Restriction',
            ...
            'elements' => array(
                ...
                'sendActions' => array(
                    ...
                    'options' => array(
                        array(
                            'action' => 'age_restriction_activate_product',
                            'width' => '100px',
                            'type' => 'submit',
                            'color' => 'green',
                            'pos' => 'left',
        ...
        // else
        : $age_restrictionDashboard->getBoxes()
    )
));