...
if( isset($_POST['validate']) ) {
	...
	}else if( $_REQUEST['age_restriction_confirmation'] == 'no' && (isset($bannerMeta['redirect_under_age']) && trim($bannerMeta['redirect_under_age']) != '') ) {
...
<head>
	...
	<style type="text/css">
		...
		.ar-box .ar-form-row input[type="text"], .ar-box .ar-remember-me, .ar-box .ar-form-row select {
		...
		.ar-box .ar-form-row label:hover, .ar-box .ar-form-row label.active {
			color: #<?php echo $bannerMeta['text_hover_color']; ?>;
		}
		<?php } ?>
	...
	<div id="wrapper">
		<div class="ar-box">
			...
			<form method="post" action="<?php the_permalink(); ?>" id="agecheck">
				...
				<input type="hidden" id="min-age" value="<?php echo $bannerMeta['minimum_age'];?>" />
				<input type="hidden" name="social_details" id="social_details" value="" />
				<input type="hidden" name="age_restriction_day" value=""/>
				<input type="hidden" name="age_restriction_month" value=""/>
				<input type="hidden" name="age_restriction_year" value=""/>
				...
				<div class="ar-form-row">
					<input type="hidden" name="age_restriction_confirmation" value=""/>
					<a href="#" data-value="yes" class="agecheck_submit"><?php _e('YES', 'age-restriction'); ?></a>
					<a href="#" data-value="no" class="agecheck_submit" style="float:right;"><?php _e('NO', 'age-restriction'); ?></a>
				</div>
